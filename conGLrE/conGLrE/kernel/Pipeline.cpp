...
{
    Matrix4f ScaleTrans, RotateTransX, RotateTransY, RotateTransZ, TranslationTrans;

    ScaleTrans.InitScaleTransform(m_scale.x, m_scale.y, m_scale.z);
	RotateTransX.Rotate3D(0,m_rotateInfo.x);
	RotateTransY.Rotate3D(1, m_rotateInfo.y);
	RotateTransZ.Rotate3D(2, m_rotateInfo.z);
    TranslationTrans.InitTranslationTransform(m_worldPos.x, m_worldPos.y, m_worldPos.z);

    m_Wtransformation =   RotateTransX * RotateTransY * RotateTransZ *TranslationTrans* ScaleTrans;
